...
public static void main(String[] args) {
        ...
        calculatePrice(householdItmes);
        System.out.println("-------------------------------------");
        packing(householdItmes);
}



	private static void calculatePrice(List<HouseholdItem> householdItems) {
		MovingCosts mcosts = new MovingCosts();
	...
	private static void packing(List<HouseholdItem> householdItems) {
		PackingInstructions packingInstruction = new PackingInstructions();

		for(HouseholdItem item : householdItems) {
			item.accept(packingInstruction);	
		}
